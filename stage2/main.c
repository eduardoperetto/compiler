...
// Use SHOULD_PRINT 1 para visualizar o processamento de tokens
...
int print_token(int token) {
  switch (token){
    ...
    case TK_ERRO:          print_nome (_(TK_ERRO)); return RET_TKNERRO; break; // Remova este return para continuar a execução em caso de erro
